...
import 'realtime_trip_updates_v1.enums.swagger.dart' as enums;
export 'realtime_trip_updates_v1.enums.swagger.dart';

part 'realtime_trip_updates_v1.swagger.chopper.dart';
part 'realtime_trip_updates_v1.swagger.g.dart';
...
@ChopperApi()
abstract class RealtimeTripUpdatesV1 extends ChopperService {
  static RealtimeTripUpdatesV1 create({
    ...
    if (client != null) {
      return _$RealtimeTripUpdatesV1(client);
    }

    final newClient = ChopperClient(
      services: [_$RealtimeTripUpdatesV1()],
    ...
    return _$RealtimeTripUpdatesV1(newClient);
  }
