...
import 'realtime_vehicle_pos_v1.enums.swagger.dart' as enums;
export 'realtime_vehicle_pos_v1.enums.swagger.dart';

part 'realtime_vehicle_pos_v1.swagger.chopper.dart';
part 'realtime_vehicle_pos_v1.swagger.g.dart';
...
@ChopperApi()
abstract class RealtimeVehiclePosV1 extends ChopperService {
  static RealtimeVehiclePosV1 create({
    ...
    if (client != null) {
      return _$RealtimeVehiclePosV1(client);
    }

    final newClient = ChopperClient(
      services: [_$RealtimeVehiclePosV1()],
    ...
    return _$RealtimeVehiclePosV1(newClient);
  }
