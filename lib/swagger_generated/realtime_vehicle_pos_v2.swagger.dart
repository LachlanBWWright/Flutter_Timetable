...
import 'realtime_vehicle_pos_v2.enums.swagger.dart' as enums;
export 'realtime_vehicle_pos_v2.enums.swagger.dart';

part 'realtime_vehicle_pos_v2.swagger.chopper.dart';
part 'realtime_vehicle_pos_v2.swagger.g.dart';
...
@ChopperApi()
abstract class RealtimeVehiclePosV2 extends ChopperService {
  static RealtimeVehiclePosV2 create({
    ...
    if (client != null) {
      return _$RealtimeVehiclePosV2(client);
    }

    final newClient = ChopperClient(
      services: [_$RealtimeVehiclePosV2()],
    ...
    return _$RealtimeVehiclePosV2(newClient);
  }
