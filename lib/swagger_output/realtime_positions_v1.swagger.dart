...
import 'realtime_positions_v1.enums.swagger.dart' as enums;
export 'realtime_positions_v1.enums.swagger.dart';

part 'realtime_positions_v1.swagger.chopper.dart';
part 'realtime_positions_v1.swagger.g.dart';
...
@ChopperApi()
abstract class RealtimePositionsV1 extends ChopperService {
  static RealtimePositionsV1 create({
    ...
    if (client != null) {
      return _$RealtimePositionsV1(client);
    }

    final newClient = ChopperClient(
      services: [_$RealtimePositionsV1()],
      ...
      errorConverter: errorConverter,
      baseUrl: baseUrl ??
          Uri.parse('http://api.transport.nsw.gov.au/v1/gtfs/vehiclepos'),
    );
    return _$RealtimePositionsV1(newClient);
  }
  ...
  ///GTFS-realtime vehicle positions for Sydney Ferries
  ///@param debug Retrieve protocol messages in a text, text-based format.  <br> Note return message may be truncated
  ...
  ///GTFS-realtime vehicle positions for Manly Fast Ferry
  ///@param debug Retrieve protocol messages in a text, text-based format.  <br> Note return message may be truncated
  ...
  ///GTFS-realtime vehicle positions for CBD & South East Light Rail
  ///@param debug Retrieve protocol messages in a text, text-based format.  <br> Note return message may be truncated
  ...
  ///GTFS-realtime vehicle positions for Inner West Light Rail
  ///@param debug Retrieve protocol messages in a text, text-based format.  <br> Note return message may be truncated
  ...
  ///GTFS-realtime vehicle positions for Newcastle Light Rail
  ///@param debug Retrieve protocol messages in a text, text-based format.  <br> Note return message may be truncated
  ...
  ///GTFS-realtime vehicle positions for Parramatta Light Rail
  ///@param debug Retrieve protocol messages in a text, text-based format.  <br> Note return message may be truncated
  ...
  ///GTFS-realtime vehicle positions for Regional Buses
  ///@param debug Retrieve protocol messages in a text, text-based format.  <br> Note return message may be truncated
