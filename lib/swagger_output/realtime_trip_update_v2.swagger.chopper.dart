...
part of 'realtime_trip_update_v2.swagger.dart';
...
final class _$RealtimeTripUpdateV2 extends RealtimeTripUpdateV2 {
  _$RealtimeTripUpdateV2([ChopperClient? client]) {
    if (client == null) return;
    this.client = client;
  }

  @override
  final Type definitionType = RealtimeTripUpdateV2;
