...
import 'realtime_trip_update_v2.enums.swagger.dart' as enums;
export 'realtime_trip_update_v2.enums.swagger.dart';

part 'realtime_trip_update_v2.swagger.chopper.dart';
part 'realtime_trip_update_v2.swagger.g.dart';
...
@ChopperApi()
abstract class RealtimeTripUpdateV2 extends ChopperService {
  static RealtimeTripUpdateV2 create({
    ...
    if (client != null) {
      return _$RealtimeTripUpdateV2(client);
    }

    final newClient = ChopperClient(
      services: [_$RealtimeTripUpdateV2()],
      ...
      baseUrl:
          baseUrl ??
          Uri.parse('http://api.transport.nsw.gov.au/v2/gtfs/realtime'),
    );
    return _$RealtimeTripUpdateV2(newClient);
  }
