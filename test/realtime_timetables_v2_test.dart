...
import 'package:lbww_flutter/swagger_generated/realtime_timetables_v2.swagger.dart';
...
void main() {
  ...
  group(
    'RealtimeTimetablesV2',
    () {
      test('metroGet returns valid response', () async {
        ...
        final service = RealtimeTimetablesV2.create(
            baseUrl:
                Uri.parse('https://api.transport.nsw.gov.au/v2/gtfs/schedule/'),
            interceptors: interceptors,
            converter: ProtobufConverter());
        logger.i('about to call endpoint');
        final response = await service.metroGet();
        //logger.i(response);
