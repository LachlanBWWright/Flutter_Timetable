  ...
  group('RealtimeTripUpdatesV1', () {
    test('busesGet returns valid response', () async {
      ...
      final client = chopper.ChopperClient(
        baseUrl: Uri.parse('https://api.transport.nsw.gov.au/v1/gtfs/realtime'),
        interceptors: interceptors,
        converter: ProtobufConverter(),
      );
      final service = RealtimeTripUpdatesV1.create(client: client);
      final response = await service.lightrailParramattaGet();
