...
import 'package:lbww_flutter/swagger_generated/realtime_vehicle_pos_v1.swagger.dart';
  ...
  group('RealtimeVehiclePosV1', () {
    test('busesGet returns valid response', () async {
      ...
      final client = chopper.ChopperClient(
        baseUrl: Uri.parse('https://api.transport.nsw.gov.au/v1/gtfs/vehiclepos'),
        interceptors: interceptors,
        converter: ProtobufConverter(),
      );
      final service = RealtimeVehiclePosV1.create(client: client);
